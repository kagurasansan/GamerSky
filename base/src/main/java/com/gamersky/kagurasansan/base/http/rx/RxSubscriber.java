package com.gamersky.kagurasansan.base.http.rx;


import com.gamersky.kagurasansan.base.BaseApplication;
import com.gamersky.kagurasansan.base.http.ServerException;
...
public abstract class RxSubscriber<T> extends DisposableSubscriber<T> {
    ...
    protected void onStart() {
        super.onStart();
        showLoading();
        if (!CheckNetwork.isNetworkConnected(BaseApplication.getBaseApplication())) {
            onNoNetWork();
            cancel();
            return;
        }
